...
from pygments.lexers import python, javascript, c_cpp, dotnet, html, css, data, go, jvm, php, ruby, rust, scripting, perl, objective, shell, spice, fortran
...
class CTkCodeBox(customtkinter.CTkTextbox):
    ...
    def __init__(self,
        ...
        self.common_langs = {
            ...
            "shell": shell.FishShellLexer,
            "spice": spice.SpiceLexer,
            "fortran": fortran.FortranLexer,
