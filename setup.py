...
setuptools.setup(
    ...
    description="A python library of helper widgets and functions for custom Tk GUI apps.",
    url="https://github.com/michaelgale/ctk-helpers-py",
    author="Michael Gale",
